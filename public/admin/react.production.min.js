...
(function (d, r) {
  ...
  function O(a, b, c, g) {
    ...
    if (Array.isArray(a))
      ...
      throw (
        ((c = '' + a),
        Error(r(31, '[object Object]' === c ? 'object with keys {' + Object.keys(a).join(', ') + '}' : c, '')))
      );
    return d;
  }
  function Q(a, b, c) {
  ...
  function za(a, b, c) {
    ...
    Array.isArray(a)
      ...
      : null != a &&
        (N(a) && (a = va(a, e + (!a.key || (b && b.key === a.key) ? '' : ('' + a.key).replace(ma, '$&/') + '/') + c)),
        g.push(a));
  }
      ...
      if (c !== b) {
        ...
        a: for (var g = 0, e = a.length; g < e; ) {
          var d = 2 * (g + 1) - 1,
            ...
            k = a[h];
          if (void 0 !== f && 0 > D(f, c))
            void 0 !== k && 0 > D(k, f) ? ((a[g] = k), (a[h] = c), (g = h)) : ((a[g] = f), (a[d] = c), (g = d));
  ...
  var p = [],
    ...
    y = !1,
    Qa = 0;
  B = { ReactCurrentDispatcher: na, ReactCurrentOwner: M, IsSomeRendererActing: { current: !1 }, assign: I };
  I(B, {
    Scheduler: {
      __proto__: null,
      ...
      unstable_scheduleCallback: function (a, b, c) {
        ...
        c = e + c;
        a = { id: Pa++, callback: b, priorityLevel: a, startTime: e, expirationTime: c, sortIndex: -1 };
        e > d
          ? ((a.sortIndex = e), S(u, a), null === n(p) && a === n(u) && (y ? V() : (y = !0), G(T, e - d)))
